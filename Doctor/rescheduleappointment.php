    		...
    		<div class="card">
        		<div class="card-body">
        			<form action="reschedulec.php" method="post">
                		<h4 class="card-title">Enter appointment ID of appointment to reschedule</h4>
						...
						<h4 class="card-title">Enter new date and time</h4>
						<input class="input100" style="color:black; width: 500px; margin-bottom:15px" id="presc" type="datetime-local" name="appdateTime" placeholder="0000-00-00 00:00:00" required> <br>
